...
# The class World implements a two dimensional environment as a NumPy matrix.
...
class World():
    ...
    def __init__(self, worldsize, frac_fill, num_enemies,
        ...
        self.en_f          = food_energy                      # Energy per food item
        self.energy        = init_energy                      # Input energy of the agent
        self.s_range       = s_range                          # Range of the each enemy's view
        self.agent_s_range = agent_s_range                    # Range of the agent's view
        
        self.view = None
        
        self.reward = 0                                       
        self.move_reward  = move_reward                       #Agent reward for moving
        self.food_reward  = food_reward                       #Agent reward for eating food
        self.wall_reward  = wall_reward                       #Agent reward for hitting wall
        self.dead_reward  = dead_reward                       #Agent reward for dying
        self.surv_reward  = surv_reward                       #Agent reward for suviving an epoch
        self.enemy_reward = enemy_reward                      #Agent reward for being eaten by enemy
    ...
    # Function like random.randint but of a given output shape
    ...
    def agent_view(self, i, j, s_range): 
        
        return self.world[i-s_range:i+s_range+1,j-s_range:j+s_range+1]
